...
public class TemplatePrincipalLayout extends AppLayout implements Loggable {
    ...
    public TemplatePrincipalLayout(final UserRepository userRepository) {
        ...
        accordionPanelFornecedor.addContent(new Div(new RouterLink("I18n", InternationalizationPage.class)));
        accordionPanelFornecedor.addContent(new Div(new RouterLink("Autocomplete", AutocompletePage.class)));
